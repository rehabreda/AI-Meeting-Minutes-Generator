            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": """You are a professional meeting minutes writer.
                     Create clear, concise, and well-structured minutes from the meeting transcript.
                     Include: key discussion points, decisions made, action items, and participants if mentioned."""},
